...
const Contact = () => {
  return (
   <>
   <Header/>
    <footer class="bg-[#f0fff0] py-10 px-10 font-sans tracking-wide mt-28">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-screen-xl mx-auto">
        <div>
          <a href='javascript:void(0)'><img src={logo} alt="logo" class='w-44' /></a>
        ...
        <div class="max-w-md md:ml-auto">
          <h4 class="text-[#333] font-bold text-lg">Contact Us</h4>
        ...
        <div>
          <h4 class="text-[#333] font-bold text-lg">Social Media</h4>
