...
const handleClick = () => {
  ...
  return (
    <>
      {/* <section class="flex  bg-black items-center flex-wrap lg:justify-start gap-4 py-3 sm:px-10 px-4 border-gray-200 border-b min-h-[75px]">
        ...
        <div class="lg:absolute lg:right-10 flex items-center ml-auto space-x-8">
          <span class="relative">
            <svg
              ...
              width="20px"
              class="cursor-pointer fill-[#333] hover:fill-[#007bff] inline-block"
              viewBox="0 0 64 64"
            >
              <path
